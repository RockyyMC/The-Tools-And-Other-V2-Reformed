...
public class BlueSlimeEntity extends Slime {
	public BlueSlimeEntity(EntityType<BlueSlimeEntity> type, Level world) {
		super(type, world);
		xpReward = 1;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(TheToolsAndOtherV2ReformedModItems.BLUE_SLIME_BALL.get()));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(TheToolsAndOtherV2ReformedModEntities.BLUE_SLIME.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
