...
public abstract class BrownWaterFluid extends BaseFlowingFluid {
	public static final BaseFlowingFluid.Properties PROPERTIES = new BaseFlowingFluid.Properties(() -> TheToolsAndOtherV2ReformedModFluidTypes.BROWN_WATER_TYPE.get(), () -> TheToolsAndOtherV2ReformedModFluids.BROWN_WATER.get(),
			() -> TheToolsAndOtherV2ReformedModFluids.FLOWING_BROWN_WATER.get()).explosionResistance(100f).tickRate(4).bucket(() -> TheToolsAndOtherV2ReformedModItems.BROWN_WATER_BUCKET.get())
			.block(() -> (LiquidBlock) TheToolsAndOtherV2ReformedModBlocks.BROWN_WATER.get());
