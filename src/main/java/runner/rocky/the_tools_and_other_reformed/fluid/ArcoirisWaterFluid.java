...
public abstract class ArcoirisWaterFluid extends BaseFlowingFluid {
	public static final BaseFlowingFluid.Properties PROPERTIES = new BaseFlowingFluid.Properties(() -> TheToolsAndOtherV2ReformedModFluidTypes.ARCOIRIS_WATER_TYPE.get(), () -> TheToolsAndOtherV2ReformedModFluids.ARCOIRIS_WATER.get(),
			() -> TheToolsAndOtherV2ReformedModFluids.FLOWING_ARCOIRIS_WATER.get()).explosionResistance(100f).tickRate(4).bucket(() -> TheToolsAndOtherV2ReformedModItems.ARCOIRIS_WATER_BUCKET.get())
			.block(() -> (LiquidBlock) TheToolsAndOtherV2ReformedModBlocks.ARCOIRIS_WATER.get());
