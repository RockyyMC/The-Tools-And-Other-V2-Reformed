...
public abstract class WaterFluid extends BaseFlowingFluid {
	public static final BaseFlowingFluid.Properties PROPERTIES = new BaseFlowingFluid.Properties(() -> TheToolsAndOtherV2ReformedModFluidTypes.WATER_TYPE.get(), () -> TheToolsAndOtherV2ReformedModFluids.WATER.get(),
			() -> TheToolsAndOtherV2ReformedModFluids.FLOWING_WATER.get()).explosionResistance(100f).tickRate(4).bucket(() -> TheToolsAndOtherV2ReformedModItems.WATER_BUCKET.get())
			.block(() -> (LiquidBlock) TheToolsAndOtherV2ReformedModBlocks.WATER.get());
