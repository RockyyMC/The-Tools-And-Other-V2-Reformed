...
public abstract class OrangeWaterFluid extends BaseFlowingFluid {
	public static final BaseFlowingFluid.Properties PROPERTIES = new BaseFlowingFluid.Properties(() -> TheToolsAndOtherV2ReformedModFluidTypes.ORANGE_WATER_TYPE.get(), () -> TheToolsAndOtherV2ReformedModFluids.ORANGE_WATER.get(),
			() -> TheToolsAndOtherV2ReformedModFluids.FLOWING_ORANGE_WATER.get()).explosionResistance(100f).tickRate(4).bucket(() -> TheToolsAndOtherV2ReformedModItems.ORANGE_WATER_BUCKET.get())
			.block(() -> (LiquidBlock) TheToolsAndOtherV2ReformedModBlocks.ORANGE_WATER.get());
