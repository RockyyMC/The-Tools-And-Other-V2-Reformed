...
public abstract class BlueWaterFluid extends BaseFlowingFluid {
	public static final BaseFlowingFluid.Properties PROPERTIES = new BaseFlowingFluid.Properties(() -> TheToolsAndOtherV2ReformedModFluidTypes.BLUE_WATER_TYPE.get(), () -> TheToolsAndOtherV2ReformedModFluids.BLUE_WATER.get(),
			() -> TheToolsAndOtherV2ReformedModFluids.FLOWING_BLUE_WATER.get()).explosionResistance(100f).tickRate(4).bucket(() -> TheToolsAndOtherV2ReformedModItems.BLUE_WATER_BUCKET.get())
			.block(() -> (LiquidBlock) TheToolsAndOtherV2ReformedModBlocks.BLUE_WATER.get());
