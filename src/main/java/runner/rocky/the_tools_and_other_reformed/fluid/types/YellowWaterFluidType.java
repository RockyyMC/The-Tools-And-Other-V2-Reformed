...
public class YellowWaterFluidType extends FluidType {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("the_tools_and_other_v2_reformed:block/yellow_water_still");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("the_tools_and_other_v2_reformed:block/yellow_water_flow");
		...
		}, TheToolsAndOtherV2ReformedModFluidTypes.YELLOW_WATER_TYPE.get());
	}
}
