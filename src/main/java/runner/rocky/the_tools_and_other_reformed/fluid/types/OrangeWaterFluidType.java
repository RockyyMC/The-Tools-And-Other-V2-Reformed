...
public class OrangeWaterFluidType extends FluidType {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("the_tools_and_other_v2_reformed:block/orange_water_still");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("the_tools_and_other_v2_reformed:block/orange_water_flow");
		...
		}, TheToolsAndOtherV2ReformedModFluidTypes.ORANGE_WATER_TYPE.get());
	}
}
