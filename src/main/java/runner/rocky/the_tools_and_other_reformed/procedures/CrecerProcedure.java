...
public class CrecerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (Math.random() < 0.01) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == TheToolsAndOtherV2ReformedModBlocks.ENREDADERA.get()) {
				{
					...
					BlockState _bs = TheToolsAndOtherV2ReformedModBlocks.ENREDADERA.get().defaultBlockState();
			...
			} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == TheToolsAndOtherV2ReformedModBlocks.ENREDADERA.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
