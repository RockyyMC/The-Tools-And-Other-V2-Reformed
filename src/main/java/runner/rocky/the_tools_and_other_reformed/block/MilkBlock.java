...
public class MilkBlock extends LiquidBlock {
	public MilkBlock(BlockBehaviour.Properties properties) {
		super(TheToolsAndOtherV2ReformedModFluids.MILK.get(), properties.mapColor(MapColor.WATER).strength(100f).noCollission().noLootTable().liquid().pushReaction(PushReaction.DESTROY).sound(SoundType.EMPTY).replaceable());
	}
}
