...
public class ColosalTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			PoiType poiType = new PoiType(ImmutableSet.copyOf(TheToolsAndOtherV2ReformedModBlocks.COLOSAL_PORTAL.get().getStateDefinition().getPossibleStates()), 0, 1);
			registerHelper.register(ResourceLocation.parse("the_tools_and_other_v2_reformed:colosal_portal"), poiType);
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = TheToolsAndOtherV2ReformedModBlocks.COLOSAL_PORTAL.get().defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
