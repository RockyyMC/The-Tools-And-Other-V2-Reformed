...
public class LapisLazuliHammerItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 5978, 11f, 0, 3, TagKey.create(Registries.ITEM, ResourceLocation.parse("the_tools_and_other_v2_reformed:lapis_lazuli_hammer_repair_items")));
